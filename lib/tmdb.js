...
export const getOnTheAirTv = () => fetchFromApi('/tv/on_the_air');

export const getAiringTodayTv = () => fetchFromApi('/tv/airing_today');

export const getUpcomingMovies = () => fetchFromApi('/movie/upcoming');

export const getByGenre = (type, genreId, page = 1, sortBy = 'popularity.desc') =>
  fetchFromApi(`/discover/${type}`, { with_genres: genreId, page, sort_by: sortBy });
...
export const getMovieImages = (id) => fetchFromApi(`/movie/${id}/images`);

export const getTvImages = (id) => fetchFromApi(`/tv/${id}/images`);
...
export const getPersonDetails = (id) => fetchFromApi(`/person/${id}`);

export const getPersonCredits = (id) => fetchFromApi(`/person/${id}/combined_credits`);

export const getMovieRecommendations = (id) => fetchFromApi(`/movie/${id}/recommendations`);

export const getTvRecommendations = (id) => fetchFromApi(`/tv/${id}/recommendations`);
...
export const fetchTvGenres = () => fetchFromApi('/genre/tv/list');
